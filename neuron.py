...
class Neuron:
    ...
    def __init__(self, weights=None, bias=0.0, activation_function='sigmoid'):
        ...
        self.weight_gradient_squares_accumulation = [0.0] * len(self.weights)  # For adaptive learning rates (e.g., AdaGrad)
        self.bias_gradient_accumulation = 0.0  # For accumulating bias gradients during backpropagation
        self.bias_gradient_squares_accumulation = 0.0  # For adaptive learning rates (e.g., AdaGrad)
